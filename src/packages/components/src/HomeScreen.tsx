        ...
        <ScrollView contentContainerStyle={styles.scrollView} bounces={false}>
          <View style={styles.container}>
            <View style={styles.header}>
              <Text style={styles.welcome}>Welcome to tI1FinalLEAP!</Text>
            </View>

            <Text style={styles.instructions}>{instructions}</Text>
            <Text style={styles.header}>DEFAULT BLOCKS</Text>
            <CustomTextItem content={"InfoPage"} onPress={() => navigation.navigate("InfoPage")} />
            ...
            <CustomTextItem
              content={"core"}
              onPress={() => this.showAlert("Error", "Could not determine assembler export")}
            />
            <CustomTextItem
              content={"SocialMediaAccountRegistrationScreen"}
              onPress={() => navigation.navigate("SocialMediaAccountRegistrationScreen")}
            />
            <CustomTextItem
            ...
            <CustomTextItem
              ...
              onPress={() => navigation.navigate("SocialMediaAccountLoginScreen")}
            />
            ...
            <CustomTextItem
              content={"MultipleCurrencySupport"}
              onPress={() => navigation.navigate("MultipleCurrencySupport")}
            />
            <CustomTextItem
