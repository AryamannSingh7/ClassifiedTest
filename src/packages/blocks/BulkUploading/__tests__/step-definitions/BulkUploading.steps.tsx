...
const feature = loadFeature('./__tests__/features/BulkUploading-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to BulkUploading', ({ given, when, then }) => {
        ...
        given('I am a User loading BulkUploading', () => {
            exampleBlockA = shallow(<BulkUploading {...screenProps}/>)
        });

        when('I navigate to the BulkUploading', () => {
             instance = exampleBlockA.instance() as BulkUploading
        });
