              ...
              <Box className="content-block">
                ...
                <Box className="main-content-block change-password-mainblock">
                  <Box className="header-block header-block-changepassword">
                    ...
                    <p>Your classified request has been sent to the building/complex manager successfully. You will get a notification once it is processed.</p> </Box>
                </Box>
...
export default withRouter(ClassifiedReportedSuccessfully)
