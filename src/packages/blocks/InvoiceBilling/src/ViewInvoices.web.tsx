...
class ViewInvoices extends ViewInvoicesController {
                    ...
                    <Box className="incident-content-wrapper">
                        ...
                        <Grid container spacing={2} style={{marginTop: "1.5rem"}}>
                            <Grid item xs={12} md={6}>
                                <Button variant="contained" className="invoicesbtn" color="primary">My Invoices</Button>
                            </Grid>
                            <Grid item xs={12} md={6}>
                                <Button variant="outlined" className="invoicesbtn">Tenant Invoices</Button>
                            </Grid>
                        </Grid>
                        {console.log("dsdsds--->",this.state?.myInvoiceList)}
                        {this.state?.myInvoiceList?.map((item: any, index: any) => ( 
                          <Card className="incident-card card" onClick={() => this.getInvoicesDetails(item.id)} key={index}>
                          <CardContent className="costom-card-content">
                          <Box className="card-listing-row">
                            <Typography component="span">
                              {/* {val?.attributes?.incident_title} */}Invoice: {moment(item.attributes.generated_on).format("MMMM Do YYYY")}
                            </Typography>
                            {
                            ...
                            <Box className="card-listing-row">
                              <Typography className="sub-title" component="h5">
                                {item.attributes.tenant_details.tenant_name}
                              </Typography>
                              <Typography className="sub-title" component="h5">
                            ...
                            <Box style={{paddingTop:"8px"}}>
                              <Typography component="span">InvoiceType</Typography>
                              <Typography className="sub-title" component="h5">
                                {item.attributes.invoice_type}
                              </Typography>
                            </Box>
                          </CardContent>
                          </Card>
