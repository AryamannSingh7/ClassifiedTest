...
class ChairmanRegistrationRequest extends ChairmanAccountLoginController {
  ...
  render() {
    console.log("getRegistrationRequest chairman ===================>",this.state?.registrationRequest?.attributes);
...
export default withRouter(ChairmanRegistrationRequest)
