...
class ResidentsProfile extends CommunityUserProfileController {
                        ...
                        return(
                          ...
                          <Card style={dashBoard.cardStyle}>
                            <CardActionArea>
                              ...
                              //@ts-ignore
                              style={dashBoard.unitnumber}>{item.unitno}</Typography>
...
//@ts-ignore
export default withTranslation()(withRouter(ResidentsProfile)); 
