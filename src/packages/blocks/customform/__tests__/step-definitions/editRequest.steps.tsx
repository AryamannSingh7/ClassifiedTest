...
import VeichleList from "../../src/EditRequest.web";
...
const feature = loadFeature("./__tests__/features/editRequest.feature");
...
defineFeature(feature, test => {
  ...
  test("User navigates to family", ({ given, when, then }) => {
    ...
    then("I am able to click Icon Button", () => {
      const backButtonCheckSpy = jest.spyOn(VeichleListBlock.find(".backIcon").at(0).props(), "onClick");
      VeichleListBlock.find(".backIcon").at(0).props().onClick();
