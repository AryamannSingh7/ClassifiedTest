...
const feature = loadFeature('./__tests__/features/TaxCalculator-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to TaxCalculator', ({ given, when, then }) => {
        ...
        given('I am a User loading TaxCalculator', () => {
            exampleBlockA = shallow(<TaxCalculator {...screenProps}/>)
        });

        when('I navigate to the TaxCalculator', () => {
             instance = exampleBlockA.instance() as TaxCalculator
        });
