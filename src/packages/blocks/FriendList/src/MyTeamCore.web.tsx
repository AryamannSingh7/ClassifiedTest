            ...
            <Container className="link-decoration">
                <Box className="navigation">
                    <Box>
                        ...
                        My Team / Team Members / <Box component="span" style={{color: "blue"}}>Core Members</Box>
                        </Typography>
                        <Typography variant="h5" className="subHeading"  >Core Members</Typography>
                    </Box>
                    <Box>
                ...
                <Grid container spacing={3} style={{marginTop: 15, marginBottom:30}}>
                    <TeamCard history={this.props.history} approval={false} handleDelete={this.handleDeleteModal}/>
                    <TeamCard history={this.props.history} approval={false} handleDelete={this.handleDeleteModal}/>
                    <TeamCard history={this.props.history} approval={false} handleDelete={this.handleDeleteModal}/>
                    <TeamCard history={this.props.history} approval={false} handleDelete={this.handleDeleteModal}/>
                    <TeamCard history={this.props.history} approval={false} handleDelete={this.handleDeleteModal}/>
    ...
    return(
        <Grid item sm={4} md={3} xs={12} style={{position:"relative"}}>
            ...
            <Box className="EventsCards" style={{paddingLeft:"0px"}}>
                <Box style={{width:"100%",display:'flex',justifyContent:"center",alignItems:"center",flexDirection:"column",marginTop:"15px"}} onClick={() => props.history.push("/SurveyDetails?id=")}>
