...
import ManagerNotificationController, { Props } from "./ManagerNotificationController.web";
import {
  Box,
  Button,
  Container,
...
class ManagerNotification extends ManagerNotificationController {
...
export default withTranslation()(withStyles(NotificationStyle)(ManagerNotification));
