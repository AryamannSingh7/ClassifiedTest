...
import ViewMyReceiptsController, {
  Props
} from "./ViewMyReceiptsController";
import './style.css'
                  ...
                  <Grid item xs={12} style={{ display:"flex", alignItems:"center", gap:"1rem",justifyContent:"space-between"}} >
                      ...
                      <Box>
                        ...
                        <IconButton style={{padding:"8px"}} >
                          ...
                          >
                              <MenuItem onClick={this.handleClose} style={{padding:"0px",minHeight:"20px"}}>Rent</MenuItem>
                              <MenuItem onClick={this.handleClose}>Management Fee</MenuItem>
                              <MenuItem onClick={this.handleClose}>Service Charge</MenuItem>
                    ...
                    <Grid container spacing={2} style={{width:"90%",marginTop:".5rem"}}>
                        <Grid item xs={12}> 
                            <Box
                                ...
                                onClick={()=>this.props.history.push("/Receipt/1")}
                            >
